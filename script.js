document.addEventListener("DOMContentLoaded", () => {
  ...
  // MODIFIED: Ensure the upload button explicitly triggers the file input 
  // and stops event propagation to prevent double triggers
  uploadBtn.addEventListener("click", (e) => {
    e.stopPropagation(); // This prevents the event from bubbling up to the drop area
    fileInput.click();
  });
